            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <#--转换json字符串-->
                        <#assign specificationList=goods.goodsDesc.specificationItems?eval />
                        <#--遍历规格-->
                        <#list specificationList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as item>
                                    <dd><a  href="javascript:;" class="{{isSelected('${spec.attributeName}','${item}')}}"
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="cart.html" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addCart()">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="tab-main intro">
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <#--转换json字符串-->
                            <#assign customAttributeList=goods.goodsDesc.customAttributeItems?eval />
